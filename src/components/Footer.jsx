...
const Footer = () => {
    return ( 
        <div className='bg-gray-400 bg-opacity-20 text-gray-400 flex flex-col justify-center items-center w-full fixed bottom-0'>
            <div className='logo font-bold text-blue-800 text-xl'>
                <span className='text-teal-500'>&lt; </span>
                <span>Lock</span>
                <span className='text-teal-500'>Safe / &gt;</span>
            ...
            <div className='flex justify-center items-center'>
                Created with <img className='w-5 m-2' src="icons/heart.png" alt="heart icon" /> by Simarpreet
            </div>
        </div>
    );
};
